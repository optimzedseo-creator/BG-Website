    ...
    <div className="c1 c1-speaking">
      ...
      <section className="subhero" id="top">
        <div className="wrap">
          ...
          <p className="lede">
            I talk about market strategy, competition, and AI, as an operator with <strong>two exits</strong>, a
          ...
          <div className="topic-list">
            <div className="topic reveal">
              ...
              <div>
                ...
                <p>Outpacing competition in markets where inventory and attention are scarce, the session behind a sell-out room at the Land Investment Expo. Who moves first, who pays for hesitation, and how to know which one you are.</p>
              </div>
            </div>
            <div className="topic reveal">
              ...
              <div>
                ...
                <p>The growth architecture behind +490% inbound-call growth and +1,000% lead growth, attribution, operating cadence, and the machinery that keeps compounding after the applause ends.</p>
              </div>
            </div>
            <div className="topic reveal">
              ...
              <div>
                ...
                <p>What AI-native marketing operations actually look like, beyond the demo reel. Where automation cuts cost, where it compounds output, and where humans still win.</p>
              </div>
            </div>
            <div className="topic reveal">
              ...
              <div>
                ...
                <p>Mission planning and composure, from the 75th Ranger Regiment to the boardroom, how elite teams decide when the cost of being wrong is absolute.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="wrap">
          ...
          <div className="feature reveal">
            <div className="feature-copy">
              <p className="where">Iowa Land Investment Expo, Des Moines, 2024</p>
              <h3>Navigating the land market: staying in front and outpacing competition</h3>
              <p>I was a featured speaker at one of agriculture&rsquo;s premier annual events, hosted by Peoples Company and running every year since 2008, before a <strong>sell-out audience of land investors, agricultural professionals, and policy leaders</strong>.</p>
              ...
              <div className="feature-facts">
                <div className="fact"><span className="k">Event</span><span className="v">Land Investment Expo, hosted by Peoples Company, est. 2008</span></div>
                <div className="fact"><span className="k">Role</span><span className="v">Featured speaker</span></div>
                <div className="fact"><span className="k">Audience</span><span className="v">Sell-out, land investors, ag professionals, policy leaders</span></div>
              </div>
            </div>
            <div className="feature-quote">
              <span className="qmark">&ldquo;</span>
              <blockquote>Buy or bury. Act quickly and buy, <em>or delay, and get buried</em> by a competitor.</blockquote>
      ...
      <section className="section debate dark" id="debate">
        <div className="wrap">
          <div className="section-intro reveal">
            <span className="microlabel">Featured venue, broadcast</span>
            <h2>Live, statewide, <em>unscripted.</em></h2>
          </div>
          <div className="debate-grid">
            <div className="debate-copy reveal">
              <p className="where">Atlanta Press Club, GPB / PBS, 2018</p>
              <h3>Loudermilk-Young Debate Series</h3>
              <p>I was selected for Georgia&rsquo;s most prominent debate series, <strong>$1M-endowed and broadcast statewide on PBS</strong>, live and unscripted, questioned by the state&rsquo;s leading journalists.</p>
              <p>No teleprompter, no second take, no friendly moderator. Ninety minutes of live television is the purest stress test a speaker can face, and the tape is public.</p>
              <div className="debate-facts">
                <div className="fact"><span className="k">Broadcast</span><span className="v">Statewide, Georgia Public Broadcasting / PBS</span></div>
                <div className="fact"><span className="k">Format</span><span className="v">Live, unscripted, panel of leading journalists</span></div>
                <div className="fact"><span className="k">Series</span><span className="v">Loudermilk-Young Debates, $1M endowment</span></div>
              </div>
            </div>
            <div className="reveal">
              ...
              <p className="video-note"><span className="tick">/</span> Atlanta Press Club Debate, full broadcast, GPB / PBS</p>
            </div>
          </div>
        </div>
      </section>

      {/* ======= TRUST-PEAK CTA (§1.6, under the debate/PBS video block) ======= */}
      <section className="peak-cta">
        <div className="wrap reveal">
          <a className="btn btn-solid" href="/contact?type=speaking">Book the stage <span className="arr">&rarr;</span></a>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="gets">
            <div className="get reveal">
              ...
              <p>+490% call volume, +1,000% leads, two successful exits, every claim on stage is a number the audience can check. The talk earns its keep with substance.</p>
            </div>
            <div className="get reveal">
              <span className="kicker">B</span>
              <h3>A story arc audiences remember</h3>
              <p>Founder to boardroom, by way of a Ranger Regiment background. An arc your attendees will retell at the reception, and cite in the post-event survey.</p>
            </div>
            <div className="get reveal">
      ...
      {/* ======= FINAL CTA ======= */}
      <section className="finale" id="book">
        <div className="wrap reveal">
          <span className="microlabel">Book the stage</span>
          <h2>Put a speaker on stage <em>who&rsquo;s held the bag.</em></h2>
          <p>Tell me about your event, the audience, the theme, the date, and I&rsquo;ll come back with a session built for the room, not a deck off the shelf.</p>
          <div className="fin-ctas"><a className="btn btn-gold" href="/contact?type=speaking">Get in Touch <span className="arr">&rarr;</span></a>
