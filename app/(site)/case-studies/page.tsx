          ...
          <div className="cs-cols">
            ...
            <div className="cs-block reveal">
              ...
              <ul>
                ...
                <li><strong>A successful exit</strong> — acquired by a UK-based equity firm expanding its US book of business. The breadth and caliber of the client roster were core drivers of the deal.</li>
              </ul>
            </div>
          </div>
          <div className="cs-results reveal">
            ...
            <div className="rgrid cols-5">
              ...
              <div className="rcell"><div className="num">Sold</div><div className="lbl">Acquired by a UK-based equity firm</div></div>
            </div>
