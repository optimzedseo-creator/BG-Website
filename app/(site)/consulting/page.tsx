    ...
    <div className="page-consulting">
      ...
      <section className="c-hero" id="top">
        <div className="wrap">
          ...
          <p className="lede">
            I&rsquo;ve been an <strong>early and relentless AI power user</strong> since before it was a line item &mdash; and I rebuild
          ...
          <div className="c-hero-ctas">
            ...
            <a className="btn btn-ghost" href="#areas">See where I&rsquo;m pointed</a>
          </div>
        </div>
      </section>
      ...
      <section className="section help" id="areas">
        <div className="wrap">
          <div className="section-intro reveal">
            ...
            <p>Costs too high, leads too few, a stack held together with duct tape, or the sense that AI is passing you by &mdash; every engagement starts with a specific problem and ends with a working system. These are the six I get hired to solve.</p>
          </div>
          <div className="areas">
            <div className="area reveal">
              ...
              <p>The pipelines that cut cost while compounding output. I design, build, and hand over the automations myself &mdash; lead routing, enrichment, follow-up, reporting &mdash; engineered around your process, not somebody&rsquo;s template.</p>
            </div>
            <div className="area reveal">
              ...
              <p>The search results page changed; most strategies didn&rsquo;t. I build for the page that exists now &mdash; AI Overviews, entity signals, Google Business Profile, and the local and long-tail plays that still convert.</p>
            </div>
            <div className="area reveal">
            ...
            <div className="area reveal">
              ...
              <p>The funnel, end-to-end: where the market opportunity actually is, how you should be positioned against it, what to charge, and how the whole machine connects &mdash; from first impression to invoice.</p>
            </div>
            <div className="area reveal">
              ...
              <p>What your competitors are doing, what they&rsquo;re missing, and where the asymmetric plays are. Structured intelligence in, ranked growth ideas out &mdash; each one with the math attached.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="engagements">
        <div className="wrap">
          <div className="section-intro reveal">
            ...
            <p>Client engagements stay confidential by default &mdash; identified here by industry, not by logo. The exception is the one where I own the platform relationship end-to-end.</p>
          </div>
          <div className="engagements">
            <div className="engage reveal">
              ...
              <p>Business, AI, and marketing counsel for a precision manufacturer navigating a rebrand and an acquisition-era transition &mdash; repositioning the company, rebuilding the web presence, and standing up AI-assisted operations while the ground moved under it.</p>
            ...
            <div className="engage reveal">
              ...
              <p>I architected and built the entire commerce platform end-to-end &mdash; custom storefront, CRM, order, label, and shipping operations, analytics, and back-office &mdash; and serve as standing strategic counsel to the owner. Not advice about a system. The system.</p>
        ...
        <div className="wrap">
          ...
          <div className="engagements">
            ...
            <div className="engage reveal">
              ...
              <p>Strategy decks don&rsquo;t move numbers; systems do. I architect and implement the automations, the CRM, the attribution, the search strategy &mdash; hands on keyboard, alongside your team &mdash; and I don&rsquo;t leave until your people can run it without me.</p>
            ...
            <div className="engage reveal">
              ...
              <p>For the operator who wants a bench. A standing line to someone who has held the P&amp;L, spent the budget, and built the machine &mdash; for the pricing call, the vendor negotiation, the hire, the &ldquo;is this AI thing real or noise&rdquo; question at 9 p.m.</p>
      ...
      <section className="section difference" id="difference">
        <div className="wrap diff-grid">
          <div className="diff-copy reveal">
            ...
            <p>I&rsquo;ve sat in the CMO seat with a <strong>$25M budget</strong> and answered for every dollar of it. I&rsquo;ve founded two companies on exactly these systems and <strong>sold both</strong>. And the automations I recommend aren&rsquo;t sketches on a whiteboard &mdash; <strong>I personally built them</strong>, node by node, prompt by prompt, in the platforms I&rsquo;m recommending.</p>
            <p className="pull">You get recommendations you can hold me to &mdash; because I&rsquo;ve held the bag.</p>
          ...
          <div className="receipts reveal">
            <div className="receipt"><span className="tag">Operator</span><h4>CMO, $25M budget</h4><p>Owned the full marketing P&amp;L across six brands &mdash; accountable for every dollar deployed and every dollar returned.</p></div>
            <div className="receipt"><span className="tag">Founder</span><h4>Two companies, two exits</h4><p>Built on the same systems I now install for clients &mdash; bootstrapped, scaled, and sold. The playbook has been paid for.</p></div>
            <div className="receipt"><span className="tag">Builder</span><h4>Hands on the keyboard</h4><p>The N8N pipelines, the prompt libraries, the CRM migrations &mdash; built personally, not delegated to a deck.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="build">
        <div className="wrap">
          <div className="section-intro reveal">
            ...
            <p>Audits find the problem &mdash; quantitative analysis of your raw platform data. AI is the build tool I use to fix it. Either way, every engagement ends in something that runs without me &mdash; not a deck about it. A sample of what&rsquo;s shipped.</p>
          </div>
          <div className="areas">
            <div className="area reveal">
              ...
              <p>Quantitative audits built from raw source data, not somebody&rsquo;s summary report &mdash; line by line through your platforms and spend, with the math attached to every finding.</p>
            </div>
            <div className="area reveal">
              <div className="a-idx">B.02</div>
              <h3>Automation &amp; attribution flows</h3>
              <p className="a-sys">N8N &middot; Make &middot; Zapier</p>
              <p>Production workflows built node by node &mdash; lead routing, enrichment, and attribution flows like CallRail into your CRM, so every closed job traces back to the call that started it.</p>
            </div>
            <div className="area reveal">
              <div className="a-idx">B.03</div>
              <h3>Software &amp; dashboards</h3>
              <p className="a-sys">Custom software &middot; Live data</p>
              <p>Software and dashboards built with AI &mdash; like the capacity-planning dashboards ops teams check every morning: live numbers a scheduler can act on, not last month&rsquo;s export.</p>
            </div>
            <div className="area reveal">
            ...
            <div className="area reveal">
              ...
              <p>Booking that lands straight on the right salesperson&rsquo;s calendar &mdash; routed by territory, job type, or whatever variables you set. No coordinator, no callback, no hands.</p>
            </div>
            <div className="area reveal">
              ...
              <p>Full commerce platforms built with AI &mdash; storefront, CRM, order and shipping operations, and the analytics to run all of it.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section help">
        <div className="wrap">
          ...
          <figure className="quote-solo reveal">
            ...
            <blockquote>He is an expert in SEO, web design, digital marketing, and lead generation &mdash; and a fantastic leader. I can confidently attest to his outstanding capabilities.</blockquote>
