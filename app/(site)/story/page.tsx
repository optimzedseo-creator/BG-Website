        ...
        <div className="wrap">
          ...
          <div className="tl-cols reveal">
            <div className="tl-col">
              ...
              <div className="tl-item"><span className="yr">2011 to 2018</span><h4>Founder &times;2 &middot; exits &times;2</h4><p>Optimized: a team of one, bootstrapped to 23 employees, $5M, and seven satellite offices, sold to an equity firm. Florida Landscaping Services: co-founded, exited successfully.</p></div>
